...
export const CLOSE_ICON = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' aria-label='Close' viewBox='0 0 24 24' class='StyledIcon-sc-ofa7kd-0 kCyiIT'%3E%3Cpath fill='none' stroke='%23000' stroke-width='2' d='m3 3 18 18M3 21 21 3'%3E%3C/path%3E%3C/svg%3E";