...
function onPaperElementPointermove(
  service: RappidService,
...
function onPaperElementPointerup(
  service: RappidService,
  _elementView: dia.ElementView,
  evt: dia.Event
): void {
  const { paper } = service;
  const { data } = evt;
...
function onPaperElementPortAdd(
  _service: RappidService,
  elementView: dia.ElementView,
  evt: dia.Event
): void {
...
function onPaperElementPortRemove(
  _service: RappidService,
  elementView: dia.ElementView,
  evt: dia.Event
): void {
...
function onPaperCellToolRemove(
  _service: RappidService,
  cellView: dia.CellView,
  _evt: dia.Event
): void {
